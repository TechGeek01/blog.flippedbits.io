...
To fix this, your router randomizes the ports. Your router might translate port 80 on your laptop to port 50000 on the WAN side of your router on the way out, and port 80 on your phone might get translated to 50001. This process, known as _**Network Address Translation**_ ensures that your router knows what traffic to send where, even though dozens of devices on your local network seem (to the internet) to be coming from the same public IP address your ISP hands you.
